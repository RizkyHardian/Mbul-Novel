...
<?php
  session_start();
 require "conn.php";
 $result = mysqli_query($conn, "SELECT * FROM light_novel");
 $novel = [];
...
<body>
              ...
              <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
                <ul class="navbar-nav">
                  ...
                  <form class="d-flex" role="search" action="search.php" method="GET">
                    ...
                    <input type="hidden" name="section" value="light_novel">
                    <input type="hidden" name="novel" value="Light">
    ...
    <h1 class="h2 mt-3 mb-4 fw-normal text-center">List Light Novel</h1>
        <table class="table">
            <tr class="table-dark">
                <th>No</th>
                <th>Judul</th>
            ...
            <tr class="table-striped border-dark">
                ...
                <td><img src="light_novel/<?=$nvl['cover']?>" width="55" height="80"><br><?php echo $nvl["cover"];?></td>
                <td><?php echo $nvl["deskripsi"];?></td>
                <td><a href="update.php?id=<?php echo $nvl['id'];?>&section=light_novel">Edit</a> | 
                <a href="pop.php?id=<?php echo $nvl['id'];?>&section=light_novel" onclick = "return confirm('Anda yakin ingin menghapus novel ini ?')">Hapus</a></td>
            </tr>
            <?php $i++; endforeach;?>
        </table>
    </main>
