                ...
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="light_user.php">Light Novel</a></li>
                      <li><a class="dropdown-item" href="web_user.php">Web Novel</a></li>
                    </ul>
                  </li>
                  <li class="nav-item">
                  ...
                  <form class="d-flex" role="search" action="search_user.php" method="GET">
