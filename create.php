    ...
    <main class="flex-shrink-0 m-auto w-100" style="max-width: 550px; padding: 15px;">
        <form action="" method="POST" enctype="multipart/form-data">
          <div class="form-check">
            <h1 class="h3 mb-3 fw-normal text-center">Tambah Novel</h1>
          ...
          if (isset($_POST['submit'])) {
            ...
            if(move_uploaded_file($temp, $tipe.'/'.$new_img)){
              $query = mysqli_query($conn, "INSERT INTO $tipe VALUES(NULL, '$judul', '$author', $volume, $chapter , '$new_img', '$deskripsi')");
              if($query){
                echo "<script>alert('Novel Berhasil Ditambahkan')
              ...
              echo "<script>alert('Terdapat Kesalahan Penambahan Novel')
              </script>";
            }
          }
          ?>
